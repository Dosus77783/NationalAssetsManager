        ...
        <>  
            <div className="pb-7">
                ...
                <form onSubmit={ formSubmition } className="grid grid-cols-1 gap-2 text-lg">
                    ...
                    <input name="username" type="text" className="border rounded-sm ps-2" id="regUsername1" onChange={ onFormChange } value={formData.username} />
                    ...
                    <input name="email" type="email" className="border rounded-sm ps-2" id="regEmail1" onChange={ onFormChange } value={formData.email} />
                    ...
                    <input name="password" type="password" className="border rounded-sm ps-2" id="regPassword1" onChange={ onFormChange } value={formData.password} />
                    ...
                    <input name="confirmPassword" type="password" className="border rounded-sm ps-2" id="regConfirm1" onChange={ onFormChange } value={formData.confirmPassword} />
